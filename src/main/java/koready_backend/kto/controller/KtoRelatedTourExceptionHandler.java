...
@RestControllerAdvice(
	assignableTypes = AdminKtoRelatedTourController.class)
public class KtoRelatedTourExceptionHandler {

	@ExceptionHandler(KtoRelatedTourNotFoundException.class)
	ResponseEntity<ApiErrorResponse> notFound(
		KtoRelatedTourNotFoundException exception,
		HttpServletRequest request
	) {
		return error(
			HttpStatus.NOT_FOUND,
			"KTO_RELATED_TOUR_NOT_FOUND",
